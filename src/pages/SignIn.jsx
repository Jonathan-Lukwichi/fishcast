    ...
    <div style={{ marginBottom: 20 }}>
      ...
      <input
        ...
        style={{
          ...
          borderRadius: 7, fontFamily: FC.sans, fontSize: 14, color: FC.ink,
    ...
    <div style={{ minHeight: '100vh', display: 'flex' }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', zIndex: 1, maxWidth: 440 }}>
          ...
          <h1 style={{
            fontFamily: FC.serif, fontSize: 'clamp(28px, 3.5vw, 46px)', fontWeight: 700,
          ...
          <div style={{ display: 'flex', gap: 28 }}>
            {STATS.map(s => (
              <div key={s.label}>
                ...
                <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', fontFamily: FC.mono, marginTop: 2 }}>{s.label}</div>
              </div>
            ))}
          </div>
          <WaveDeco color={FC.eco300} width={280} style={{ marginTop: 40, opacity: 0.4 }} />
        </div>

        <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.18)', fontFamily: FC.mono, position: 'relative', zIndex: 1 }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 360, width: '100%', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 14, color: FC.ink50, marginBottom: 28, lineHeight: 1.5 }}>
          ...
          <button className="fc-btn-ghost" onClick={handleDemo}
            style={{ width: '100%', padding: '12px', fontSize: 13, color: FC.ink70 }}>
            Continuer en mode démo →
          </button>

          <p style={{ textAlign: 'center', marginTop: 22, fontSize: 13, color: FC.ink50 }}>
          ...
          <div style={{ marginTop: 32, padding: '14px 16px', background: FC.off, borderRadius: 8, border: `1px solid ${FC.rule}` }}>
